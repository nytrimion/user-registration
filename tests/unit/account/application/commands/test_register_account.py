...
Testing Strategy:
    - Mock AccountRepository using unittest.mock
...
def test_register_account_success_when_email_available() -> None:
    ...
    # Create handler with mocked dependency (no @inject needed in tests)
    handler = RegisterAccountHandler(repository=mock_repository)
